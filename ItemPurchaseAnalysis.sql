...
FROM `bellaaurora.analytics_348556202.events_*`, UNNEST (event_params) AS event_params
...
FROM `bellaaurora.analytics_348556202.events_*`, UNNEST (items) AS items, total_visitas
